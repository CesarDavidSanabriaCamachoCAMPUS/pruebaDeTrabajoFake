CREATE DATABASE db_campusMall_Cesar;

USE db_campusMall_Cesar;
...
CREATE TABLE productos(
    ...
    estado TINYINT(4),
    created_by BIGINT(20) UNSIGNED, FOREIGN KEY(created_by) REFERENCES users(id),
    update_by BIGINT(20) UNSIGNED, FOREIGN KEY(update_by) REFERENCES users(id),
    created_at TIMESTAMP,
    updated_at TIMESTAMP,
    deleted_at TIMESTAMP
);
...
CREATE TABLE bodegas(
    id BIGINT(20) UNSIGNED PRIMARY KEY,
    nombre VARCHAR(255),
    id_responsable BIGINT(20) UNSIGNED, FOREIGN KEY (id_responsable) REFERENCES users(id),
    estado TINYINT(4),
    created_by BIGINT(20) UNSIGNED, FOREIGN KEY (created_by) REFERENCES users(id),
    update_by BIGINT(20) UNSIGNED, FOREIGN KEY (update_by) REFERENCES users(id),
    created_at TIMESTAMP,
...
CREATE TABLE inventarios(
    id BIGINT(20) UNSIGNED PRIMARY KEY,
    id_bodega BIGINT(20) UNSIGNED, FOREIGN KEY (id_bodega) REFERENCES bodegas(id),
    id_producto BIGINT(20) UNSIGNED, FOREIGN KEY (id_producto) REFERENCES productos(id),
    cantidad INT(11),
    created_by BIGINT(20) UNSIGNED, FOREIGN KEY (created_by) REFERENCES users(id),
    update_by BIGINT(20) UNSIGNED, FOREIGN KEY (update_by) REFERENCES users(id),
    created_at TIMESTAMP,
...
CREATE TABLE historiales(
    id BIGINT(20) UNSIGNED PRIMARY KEY,
    cantidad INT(11),
    id_bodega_origen BIGINT(20) UNSIGNED, FOREIGN KEY (id_bodega_origen) REFERENCES bodegas(id),
    id_bodega_destino BIGINT(20) UNSIGNED, FOREIGN KEY (id_bodega_destino) REFERENCES bodegas(id),
    id_inventario BIGINT(20) UNSIGNED, FOREIGN KEY (id_inventario) REFERENCES inventarios(id),
    created_by BIGINT(20) UNSIGNED, FOREIGN KEY (created_by) REFERENCES users(id),
    update_by BIGINT(20) UNSIGNED, FOREIGN KEY (update_by) REFERENCES users(id),
    created_at TIMESTAMP,
    updated_at TIMESTAMP,
